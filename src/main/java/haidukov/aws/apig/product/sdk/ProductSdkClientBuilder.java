...
/**
 * Fluent builder for {@link haidukov.aws.apig.product.sdk.ProductSdk}.
 * 
 * @see haidukov.aws.apig.product.sdk.ProductSdk#builder
 **/
@NotThreadSafe
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public final class ProductSdkClientBuilder extends SdkSyncClientBuilder<ProductSdkClientBuilder, ProductSdk> {

    private static final URI DEFAULT_ENDPOINT = RuntimeHttpUtils.toUri("ze7yzjj9y2.execute-api.us-east-1.amazonaws.com", Protocol.HTTPS);
