...
public class DeleteProductResult extends com.amazonaws.opensdk.BaseResult implements Serializable, Cloneable {
    ...
    public DeleteProductResult empty(Empty empty) {
        setEmpty(empty);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteProductResult == false)
            return false;
        DeleteProductResult other = (DeleteProductResult) obj;
    ...
    @Override
    public DeleteProductResult clone() {
        try {
            return (DeleteProductResult) super.clone();
