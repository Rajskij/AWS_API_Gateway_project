...
public class PatchUpdateResult extends com.amazonaws.opensdk.BaseResult implements Serializable, Cloneable {
    ...
    public PatchUpdateResult empty(Empty empty) {
        setEmpty(empty);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PatchUpdateResult == false)
            return false;
        PatchUpdateResult other = (PatchUpdateResult) obj;
    ...
    @Override
    public PatchUpdateResult clone() {
        try {
            return (PatchUpdateResult) super.clone();
