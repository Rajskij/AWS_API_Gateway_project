...
public class PutUploadResult extends com.amazonaws.opensdk.BaseResult implements Serializable, Cloneable {
    ...
    public PutUploadResult empty(Empty empty) {
        setEmpty(empty);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PutUploadResult == false)
            return false;
        PutUploadResult other = (PutUploadResult) obj;
    ...
    @Override
    public PutUploadResult clone() {
        try {
            return (PutUploadResult) super.clone();
